...
* [Sinatra](#sinatra)
    ...
    * [Personalizar Rutas](#custom-route-matchers)
    * [Archivos estáticos](#static-files)
    * [Vistas / Plantillas](#views--templates)
        * [Plantillas literales](#literal-templates)
        * [Lenguajes de plantillas disponibles](#available-template-languages)
            * [Plantillas Haml](#haml-templates)
            * [Plantillas Erb](#erb-templates)
            * [Plantillas Builder](#builder-templates)
            * [Plantillas Nokogiri](#nokogiri-templates)
            * [Plantillas Sass](#sass-templates)
            * [Plantillas SCSS](#scss-templates)
            * [Plantillas Less](#less-templates)
            * [Plantillas Liquid](#liquid-templates)
            * [Plantillas Markdown](#markdown-templates)
            * [Plantillas Textile](#textile-templates)
            * [Plantillas RDoc](#rdoc-templates)
            * [Plantillas AsciiDoc](#asciidoc-templates)
            * [Plantillas Radius](#radius-templates)
            * [Plantillas Markaby](#markaby-templates)
            * [Plantillas RABL](#rabl-templates)
            * [Plantillas Slim](#slim-templates)
            * [Plantillas Creole](#creole-templates)
            * [Plantillas MediaWiki](#mediawiki-templates)
            * [Plantillas CoffeeScript](#coffeescript-templates)
            * [Plantillas Stylus](#stylus-templates)
            * [Plantillas Yajl](#yajl-templates)
            * [Plantillas WLang](#wlang-templates)
        * [Accediendo a las variables desde las plantillas](#accessing-variables-in-templates)
        * [Plantillas con `yield` y capas anidadas](#templates-with-yield-and-nested-layouts)
        * [Plantillas en linea](#inline-templates)
        * [Plantillas con nombres](#named-templates)
        * [Asociar tipos de archivos](#associating-file-extensions)
